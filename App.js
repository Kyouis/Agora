...
const createDB = () => {
    db.transaction( (tx) => {
        ...
        tx.executeSql("CREATE TABLE IF NOT EXISTS ELEMENT (idElem INTEGER PRIMARY KEY AUTOINCREMENT , strate TEXT, classe TEXT, sousClasse TEXT, denom TEXT, idComp integer, foreign key (idComp) REFERENCES COMPARTIMENT (idComp) ON DELETE CASCADE )")
